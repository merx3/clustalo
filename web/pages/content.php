<div id="input_wrapper">
	...
	<form id="input" method="post" action="/home.php" enctype="multipart/form-data">
		...
		<div id="clust" class="WebtoolsDesc">
				...
				Файл с готово guide tree:<br/>
					<input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
					&nbsp;&nbsp;&nbsp;&nbsp; <input name="guide_tree_in" type="file" /><br/>
				Показване на guide tree в резултата: <input name="guide_tree_out" type="checkbox"></input><br/>
				Използване на пълна матрица на разстоянията за guide tree изчисления (бавно): <input name="use_full_matr" type="checkbox"></input><br/>
				Използване на пълна матрица на разстоянията за guide tree изчисления при итерации: <input name="use_full_matr_iter" type="checkbox"></input><br/>
		...
		<div class="WebtoolsTitle"><h3>Подредба на изхода (<a href="javascript:toggleMe('align_out');">hide/show</a>)</h3></div>
		...
		<div id="iter" class="WebtoolsDesc">
			...
			Максимален брой guide-tree итерации : <input name="max_guidetree_iter"  type="number" value=0 min=0></input><br/>
